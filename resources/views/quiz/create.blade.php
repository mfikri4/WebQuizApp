...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Buat data pertanyaan') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('quiz/create') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="from_time" type="datetime-local" class="form-control @error('from_time') is-invalid @enderror" name="from_time" value="{{ old('from_time') }}" required autocomplete="from_time" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="to_time" type="datetime-local" class="form-control @error('to_time') is-invalid @enderror" name="to_time" value="{{ old('to_time') }}" required autocomplete="to_time" autofocus>
